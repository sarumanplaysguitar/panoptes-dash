...
<div class="h-[calc(100vh_-_3.5rem)] grid grid-cols-1 grid-rows-1 md:py-3 md:h-screen">
            ...
            <!-- <div class="grid grid-cols-1 grid-rows-[1fr_12_12_12_12] place-items-center"> -->
                ...
                <div class="mt-auto flex flex-rows">
                    ...
                    <div class="ml-2 pb-2">
                        ...
                        <div class="animate-avg-pulse flex font-semibold tracking-widest text-xs uppercase text-neutral-300 leading-3 items-center">
                ...
                <div class="text-neutral-600 text-sm mt-2">
                    <p class="flex items-center text-neutral-300 text-sm text-center">
                        <img :src="flag" alt="Country Flag" class="inline-block rounded-sm scale-90 grayscale pr-[0.35rem]" /> Mt. Wilson, California, USA</p>
        ...
        <div class="z-0 row-start-1 col-start-1 bg-gradient-to-b from-neutral-800 from-55% to-neutral-850 to-65% rounded-md h-full"> </div>
