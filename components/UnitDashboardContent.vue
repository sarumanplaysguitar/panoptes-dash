...
<template>
  <div class="bg-neutral-900 flex flex-col py-2 px-1 md:h-screen">
    <ul class="flex h-10">
      <li class="pt-1 px-1">
        <button
            :class="['inline-block', 'font-semibold', 'rounded-md', 'py-2', 'px-4', 'mr-2', 'tracking-widest', 'text-xs', 'uppercase', tab === 1 ? 'bg-neutral-800 text-neutral-300 border-2 border-neutral-800' : 'bg-neutral-900 text-neutral-500 border-2 border-neutral-900']"
            @click="tab = 1">
        ...
        <button
            :class="['inline-block', 'font-semibold', 'rounded-md', 'py-2', 'px-4', 'tracking-widest', 'text-xs', 'uppercase', tab === 2 ? 'bg-neutral-800 text-neutral-300 border-2 border-neutral-800' : 'bg-neutral-900 text-neutral-500 border-2 border-neutral-900']"
            @click="tab = 2">
                    <span class="material-symbols-outlined text-xs inline-block align-top pr-0.5">
                        <!-- menu_book -->
                        summarize
    ...
    <div class="flex">
      <div v-if="tab === 1"
           class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2 w-full p-1 pb-2 mt-1">
        ...
        <div
            class="grid grid-cols-1 md:grid-cols-[8rem_1fr] auto-rows-min gap-y-8 md:gap-y-4 rounded-md col-span-1 md:col-span-2 bg-neutral-800 px-4 pb-4 pt-3 text-neutral-500">
            ...
            <div class="text-neutral-500 text-center md:text-left w-full">
              ...
              <div class="flex flex-col md:flex-row flex-wrap items-center p-1 gap-2 md:justify-normal">
                ...
                <div class="flex justify-center">
                  ...
                  <div
                      class="border-1 border-neutral-700 bg-neutral-700 rounded-r ml-0 outline outline-0 outline-neutral-800 py-0 px-2">
        ...
        <div class="rounded-md bg-neutral-800 p-4 text-neutral-500 col-span-1 md:col-span-2">[weather]
          ...
          doloremque eveniet aliquam assumenda in quae repudiandae corporis voluptatum eum consectetur incidunt eligendi
          cum architecto?
        </div>

        <!-- Card: Moon -->
        <div
            class="col-span-1 md:col-span-2 grid grid-cols-[8rem_1fr] rounded-md bg-neutral-800 py-2 px-4 text-neutral-500">
      ...
      <div v-if="tab === 2"
           class="grid grid-cols-1 lg:grid-cols-[1fr_12rem] xl:grid-cols-[1fr_16rem] grid-flow-row w-full h-full p-1 md:pb-2 mt-1">
        <!-- Date selection -->
